  ...
  return <main className={styles.page}>
    ...
    <section className={styles.board}>
      <article className={`${styles.card} ${styles.heroCard}`}>
        <div className={styles.heroGlow}/><div className={styles.heroBeam}/>
      ...
      <div className={styles.sideCards}>
        <article className={`${styles.card} ${styles.insightCard}`}><div className={styles.moon}/><span className={styles.icon}>▢</span><h3>Insights e Conteúdo</h3><p>Artigos e guias sobre IA,<br/>comunicação e produtividade.</p><button>→</button></article>
        <article className={`${styles.card} ${styles.meetingCard}`}><div className={styles.crystals}/><span className={styles.icon}>▣</span><h3>Analisar Reuniões</h3><p>Reviva conversas, identifique<br/>pontos-chave e gere insights.</p><button>→</button></article>
      </div>
      ...
      <article className={`${styles.card} ${styles.analysisCard}`}>
        ...
        <div className={styles.phone} aria-hidden="true"><div className={styles.phoneBody}><i/><i/><i/><b/></div></div>
