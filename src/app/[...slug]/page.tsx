...
export default async function FeaturePage({ params }:{ params:Promise<{slug:string[]}> }){
  ...
  return <main style={{minHeight:'100dvh',display:'grid',placeItems:'center',background:'radial-gradient(circle at 60% 20%,#15293c 0,#07111d 38%,#02070d 75%)',color:'#fff',fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif',padding:32}}>
